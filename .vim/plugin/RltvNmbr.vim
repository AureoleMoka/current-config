...
"  call Dfunc("RltvNmbr#RltvNmbrCtrl(start=".a:start.")")
  ...
  if      a:start && !exists("s:rltvnmbr_{bufnr('%')}")
   ...
   if !exists("s:rltvnmbr_signs")
	...
	hi default HL_RltvNmbr_Minus	gui=NONE ctermfg=white   ctermbg=none guifg=burlywood3   guibg=dark
	hi default HL_RltvNmbr_Positive	gui=NONE ctermfg=white ctermbg=none guifg=burlywood3 guibg=dark
...
"  call Dfunc("s:ColorschemeLoaded()")
	hi HL_RltvNmbr_Minus	ctermfg=180   ctermbg=none guifg=burlywood3   guibg=dark
	hi HL_RltvNmbr_Positive	ctermfg=180 ctermbg=none guifg=burlywood3 guibg=dark
